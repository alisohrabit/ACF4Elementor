...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'elementor-acf4ele' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Title', 'elementor-acf4ele' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'elementor-acf4ele' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'elementor-acf4ele' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'elementor-acf4ele' ),
			]
		);
